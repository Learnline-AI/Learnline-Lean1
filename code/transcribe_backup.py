...
DEFAULT_RECORDER_CONFIG: Dict[str, Any] = {
    ...
    "spinner": False,
    "model": "base",  # Changed to multilingual base model
    ...
    "no_log_file": True,
    "wake_words": "",  # Disabled wake words for continuous transcription
    "wakeword_backend": "pvporcupine",
    "allowed_latency_limit": 300,  # Reduced for better real-time performance
    "debug_mode": False,  # Reduced logging for production
    "initial_prompt_realtime": "Hello, how are you today? नमस्ते, आप कैसे हैं?",  # Hindi/English mixed prompt
    "faster_whisper_vad_filter": True,  # Enabled for better performance
