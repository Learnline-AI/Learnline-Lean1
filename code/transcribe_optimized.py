...
LANGUAGE_MODELS = {
    ...
    "hi": {
        "model": "base",  # Use multilingual base model for Hindi
        "realtime_model": "base",
        "name": "Hindi",
        "whisper_code": "hi"
    },
    "hi-en": {
        "model": "base",  # Multilingual model for code-switching
        "realtime_model": "base",
...
# Optimized default configuration for live transcription
DEFAULT_RECORDER_CONFIG: Dict[str, Any] = {
    "use_microphone": False,
    "spinner": False,
    "model": "base",  # Multilingual base model
    ...
    "allowed_latency_limit": 300,  # Reduced for better real-time performance
...
class OptimizedTranscriptionProcessor:
    ...
    _PIPELINE_RESERVE_TIME_MS: float = 0.015  # Reduced for faster response
    ...
    _TRANSCRIPTION_CACHE_SIZE: int = 1000  # Maximum transcription history
    _AUTO_SAVE_INTERVAL: int = 100  # Auto-save every N transcriptions
    ...
    def _normalize_text(self, text: str) -> str:
        ...
        text = re.sub(r'[^a-z0-9\\s\\u0900-\\u097F\\u0980-\\u09FF\\u0A00-\\u0A7F]', '', text)
