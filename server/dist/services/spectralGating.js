...
`;
    ...
    async applySpectralGating(audioBuffer) {
        ...
        const scriptPath = path.join(this.tempDir, 'spectral_gating.py');
        try {
            const wavBuffer = audioUtils_1.AudioUtils.pcmToWAV(audioBuffer, 16000, 1, 16);
    ...
    runPythonScript(scriptPath, inputPath, outputPath) {
        return new Promise((resolve, reject) => {
            const python = (0, child_process_1.spawn)('python3', [scriptPath, inputPath, outputPath], {
...
exports.SpectralGatingService = SpectralGatingService;
//# sourceMappingURL=spectralGating.js.map